...
import dev.stas.weatherapp.R
import dev.stas.weatherapp.domain.entity.Forecast
import dev.stas.weatherapp.domain.entity.Weather
import dev.stas.weatherapp.presentation.extensions.formattedFullDate
import dev.stas.weatherapp.presentation.extensions.formattedShortDayOfWeek
import dev.stas.weatherapp.presentation.extensions.tempToFormattedString
import dev.stas.weatherapp.presentation.ui.theme.CardGradients


@Composable
fun DetailsContent(component: DetailComponent) {
    ...
    Scaffold(
        ...
        topBar = {
            TopBar(
                ...
                onClickChangeFavouriteStatus = { component.onClickChangeFavoriteStatus() }
            )
        },
        modifier = Modifier
            .fillMaxSize()
        ...
        Box(modifier = Modifier.padding(padding)) {
            when (val forecastState = state.forecastState) {
                ...
                DetailStore.State.ForecastState.InitialState -> {
                    Initial()
                }
